...
layout: default
title: Bioacoustics
description: Automated acoustic monitoring — bat ultrasound detection on Praslin, the curious failure of BirdNET-Pi in the Seychelles, and what it produces when pointed at the Devon countryside.
category: Field research
tags: [bioacoustics, bats, birds, birdnet, seychelles, praslin, devon, acoustic monitoring, passive monitoring]
---
...
## Why BirdNET-Pi doesn't work here
...
Once it's up and running, you get a lot of really useful data that you can use to analyse the behaviours of birds in your local area. You can, of course, do sillier things with it too.

Inspired by listening to Joy Division, I thought a ridgeline plot might be the best way to show some of the time-of-day patterns. Here's when in the day each species was detected, coloured by the average confidence of the identification.

![Ridgeline plot of bird detection patterns by time of day, coloured by average confidence score](/assets/img/birdnet-ridgeline.png)
...
The cover is a plot of successive radio pulses from the first pulsar ever discovered, CP 1919, superimposed vertically — taken from *Radio Observations of the Pulse Profiles and Dispersion Measures of Twelve Pulsars* (Craft, 1970). [Scientific American has already done such a good job](https://www.scientificamerican.com/blog/sa-visual/pop-culture-pulsar-origin-story-of-joy-division-s-unknown-pleasures-album-cover-video/) covering the origin of the image. The full dataset and its origin are explained there — and we can use it to recreate the cover directly in R.

![Recreation of the Joy Division Unknown Pleasures album cover using CP 1919 pulsar data](/assets/img/cp1919-pulsar.png)
...
![BirdNET-Pi bird detection data rendered in the style of Joy Division's Unknown Pleasures](/assets/img/birdnet-jd.png)
